(function($){
    ...
    $(function(){
        ...
        // Try my service
    var tryOurService = (function () {
    // body...
    var $el = $('#tryservice_items');
    $el.find("#tryServiceBtn").on('click',  _sendsms );

    function _sendsms (element){
        var mobileNo =  $('#tryservice_items').find("input").val();
        var URL =  "http://luna.a2wi.co.in:7501/failsafe/HttpLink?aid=633328&pin=jak12&mnumber=919920986161&message=Welcome.Thanks for your interest.Please write to us at support@jakewer.com&signature=JAKCOM";
        URL = URL.replace("919920986161", mobileNo);
        var win = window.open(URL, '_blank');
        document.getElementById("tryServiceBtn").className += " disabled";
